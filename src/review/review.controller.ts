...
export class ReviewController {
  ...
  @Get()
  @ApiOperation({
    summary: 'Get list of reviews with optional filters and pagination',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get a reviews by ID' })
  @ApiParam({ name: 'id', description: 'ID of the reviews', type: Number })
  ...
  @Put(':id')
  @UseGuards(JwtAuthGuard)
  @ApiOperation({ summary: 'Update an existing reviews' })
  @ApiParam({
    name: 'id',
  ...
  @Delete(':id')
  @UseGuards(JwtAuthGuard)
  @ApiOperation({ summary: 'Delete a reviews by ID' })
  @ApiParam({
    name: 'id',
    description: 'ID of the reviews to delete',
    type: Number,
  })
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles('admin')
  @ApiOperation({ summary: 'Admin: Get reviews by ID' })
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles('admin')
  @ApiOperation({ summary: 'Admin: Delete any reviews' })
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Roles('admin')
  @ApiOperation({ summary: 'Admin: Update any reviews' })
  async adminUpdate(
    @Param('id', ParseIntPipe) id: number,
